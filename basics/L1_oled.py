...
def getVoltage():
    ...
    ##########################################
    return  BV # Be sure to return your variable name for your getVoltage()
...
def displayText():
    ...
    #################################################
    draw.text((40, 0), "REVBOT", font=font, fill=255)
    ...
    draw.text((0, 40),"Robot Voltage:%6.2fV" % getVoltage(), font=font, fill=255)
